...
const unsigned int KEYCODES_WASD[NUM_KEYS] = { 'W', 'S', 'A', 'D', ' ', 'Q', 'E' };
const unsigned int KEYCODES_CURSOR_GAME[NUM_KEYS] = { KEY_UP_ARROW, KEY_DOWN_ARROW, KEY_LEFT_ARROW, KEY_RIGHT_ARROW, ' ', 'Q', 'E' };
