 ...
 * will disable it entirely. Effects are not available in the default mode
 * (for vintage systems), you should only activate one of them.
 */
#define LED_UNDERGLOW_MAX 128         // Maximum brightness
 ...
 */
#define USB_ALTERNATE_MODE KEY_MODE_JOYSTICK
 ...
 *   KEYCODES_VICE            - VICE numpad joystick, joystick-mode recommended
 *                              used instead.
 * 
